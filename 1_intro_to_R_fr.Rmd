...
1. Un seul dossier, clarté sur le répertoire de travail
1. Chemins absolus et relatifs
1. Confier aux scripts, pas à l'espace de travail
...
1. Gérer un token API (avez vou décrit pourquoi vous créez ce token?)
...
- Les projets RStudio créent un fichier __.Rproj__ dans votre dossier qui sert de raccourci pour vos projets et signale a RStudio où ke travail sera fait
